    ...
    <div className="about" id="about">
        <blockquote className="blockquote mb-0">
          ...
          <p>
            ...
            notary service experience as well as 5 years experience working in a
            ...
            will assure the signing process goes smoothly for the client and I
            can confidently give a brief overviews, if needed, without stepping
